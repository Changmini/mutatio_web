...
<%
		...
		Elements postsLink = url.getElementsByAttributeValue("class", "grid-hero-teaser__link");
		for (Element e : postsLink) {
            links[0] = "https://www.science.org" + e.getElementsByAttribute("href").attr("href");
		}
...
<!-- ===================================================================== -->
	...
	<div id="searchBackground">
		<div id="searchArea">
        	<form action="/thesisList.do" method="post">
        		<sec:csrfInput/>
        ...
        <ul>
            <li>
                <div class="last_bg1">
                    ...
                    <p>저작권 관련 문의</p>
                    <div class="more2">
                        <p><a href='<c:url value="/member/quesList.do"/>'>더 알아보기</a></p>
                    </div>
                </div> 
            </li>
            ...
            <li>
                <div class="last_bg2">
                    ...
                    <p>자유 게시판</p>
                    <div class="more2">
                        <p><a href='<c:url value="/freeList.do"/>'>더 알아보기</a></p>
                    </div>
                </div>
            </li>
        </ul>
